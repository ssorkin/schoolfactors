...
<svelte:head>
  <title>LAUSD enrollment (original, Aug 21 2026) — SchoolFactors</title>
...
<p class="draftnote">
  Archived original (August 21, 2026). A revised version incorporating ACS
  1-year data through 2024 is at <a href="/lausd/enrollment">the current
  article</a>.
</p>
