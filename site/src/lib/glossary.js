...
export const GLOSSARY = [
  ...
  },
  {
    ...
    def: [
      ...
      'School pools additionally separate alternative programs (continuation, community day, court, special-ed) and exam-admission selective schools from the general pool: student selection, not performance, would otherwise place them at the extremes of a shared ranking. Each is ranked among its own kind, and a pool smaller than 20 shows no percentile at all.',
