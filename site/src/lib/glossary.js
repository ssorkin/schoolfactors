...
export const GLOSSARY = [
  ...
  },
  {
    ...
    def: [
      ...
      'School, district, and county pages also show this percentile per year, as a row of chips under the entity name. Each chip is refit using only test results from BEFORE that year — the chip shown for 2024 was computable before 2024’s tests existed, with the demographic averages likewise restricted to earlier years — so the row is an out-of-sample record: stable chips mean the ranking would have told you the same thing years in advance. The "now" chip is the current percentile using all years. Years the school tested but could not yet be ranked (too little earlier data) appear as empty chips.',
      'Every entity page works this calculation through under "Performance, growth and trend" (open "Show the calculation"): the raw level, each characteristic\u2019s contribution to the expected level, the residual, its shrinkage and lower bound, and where that lower bound falls in the pool\u2019s histogram.',
